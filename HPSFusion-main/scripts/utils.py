...
low_light_prompt_path = "./dataset/LLVIP/Low_light/train/text.txt"
...
over_exposure_prompt_path = "./dataset/LLVIP/Over_exposure/train/text.txt"
...
ir_low_contrast_prompt_path = "./dataset/LLVIP/IR_Low_contrast/train/text.txt"
...
ir_noise_prompt_path = "./dataset/LLVIP/IR_Noise/train/text.txt"
