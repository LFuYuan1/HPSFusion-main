...
from model.HFSF_model import HFSF_model as create_model
...
def main(args):
    ...
    filefold_path = "./experiments/HFSF_model_train_{}".format(file_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--low_light_path', type=str, default="./dataset/")
    parser.add_argument('--over_exposure_path', type=str, default="./dataset/")
    parser.add_argument('--ir_low_contrast_path', type=str, default="./dataset/")
    parser.add_argument('--ir_noise_path', type=str, default="./dataset/")
